...
x86_64_fill_gregset (void *buf)
{
  ...
  for (i = 0; i < X86_64_NUM_GREGS; i++)
    if (x86_64_regmap[i] != -1)
      egdb_collect_register (i, ((char *) buf) + x86_64_regmap[i]);
}
...
x86_64_store_gregset (const void *buf)
{
  ...
  for (i = 0; i < X86_64_NUM_GREGS; i++)
    if (x86_64_regmap[i] != -1)
      egdb_supply_register (i, ((char *) buf) + x86_64_regmap[i]);
}
...
x86_64_get_pc ()
{
  ...
  egdb_collect_register_by_name ("rip", &pc);
...
x86_64_set_pc (CORE_ADDR newpc)
{
  ...
  egdb_supply_register_by_name ("rip", &newpc);
}

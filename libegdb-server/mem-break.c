...
void
egdb_delete_breakpoint_at (CORE_ADDR addr)
{
...
static int
egdb_reinsert_breakpoint_handler (CORE_ADDR stop_pc)
{
...
void
egdb_reinsert_breakpoint_by_bp (CORE_ADDR stop_pc, CORE_ADDR stop_at)
{
  ...
  set_breakpoint_at (stop_at, egdb_reinsert_breakpoint_handler);
...
void
egdb_uninsert_breakpoint (CORE_ADDR stopped_at)
{
  struct breakpoint *bp;
...
void
egdb_reinsert_breakpoint (CORE_ADDR stopped_at)
{
  struct breakpoint *bp;
...
int
egdb_check_breakpoints (CORE_ADDR stop_pc)
{
  struct breakpoint *bp;
...
void
egdb_set_breakpoint_data (const unsigned char *bp_data, int bp_len)
{
...
void
egdb_check_mem_read (CORE_ADDR mem_addr, unsigned char *buf, int mem_len)
{
  struct breakpoint *bp = breakpoints;
...
void
egdb_check_mem_write (CORE_ADDR mem_addr, unsigned char *buf, int mem_len)
{
  struct breakpoint *bp = breakpoints;
  CORE_ADDR mem_end = mem_addr + mem_len;
...
void
egdb_delete_all_breakpoints (void)
{
  while (breakpoints)

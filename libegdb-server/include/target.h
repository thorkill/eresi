...
struct target_ops
{
  ...
  /* Read memory from the inferior process.  This should generally be
     called through egdb_read_inferior_memory, which handles breakpoint shadowing.
...
void egdb_set_target_ops (struct target_ops *);
...
int egdb_read_inferior_memory (CORE_ADDR memaddr, unsigned char *myaddr, int len);

int write_inferior_memory (CORE_ADDR memaddr, const unsigned char *myaddr,
			   int len);

void egdb_set_desired_inferior (int id);

...
#define get_thread_process(thr) (get_process (egdb_inferior_target_data (thr)))
...
void egdb_linux_attach_lwp (unsigned long pid);

int egdb_thread_db_init (int use_events);

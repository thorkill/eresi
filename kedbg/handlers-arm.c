...
void            kedbg_print_reg_ARM(void)
{
  ...
  e2dbg_register_dump("r13_irq",      reg->r13_irq);
  e2dbg_register_dump("r14_irq",      reg->r14_irq);
  e2dbg_register_dump("r13_svc",      reg->r13_svc);
  e2dbg_register_dump("r14_svc",      reg->r14_svc);
  e2dbg_register_dump("r13_abt",      reg->r13_abt);
  e2dbg_register_dump("r14_abt",      reg->r14_abt);
  e2dbg_register_dump("r13_und",      reg->r13_und);
  e2dbg_register_dump("r14_und",      reg->r14_und);

...
static void setup_elfhash()
{
  ...
  hash_add(&elf_L2_hash, "pax_pageexec", revm_create_L2ENT(elfsh_get_pax_pageexec,
           ...
           NULL, NULL,
           NULL, NULL));
  hash_add(&elf_L2_hash, "pax_emultramp",
           revm_create_L2ENT(elfsh_get_pax_emultramp,
...
static void setup_dynsymhash()
{
  ...
  hash_add(&dynsym_L2_hash, "type", revm_create_L2ENT(elfsh_get_symbol_type,
           ...
           ASPECT_TYPE_BYTE, NULL,
           NULL, NULL, NULL));
  hash_add(&dynsym_L2_hash, "other",
           revm_create_L2ENT(elfsh_get_symbol_visibility,
                             elfsh_set_symbol_visibility,
                             ASPECT_TYPE_BYTE, NULL,
                             NULL, NULL, NULL));
...
static void setup_gothash()
{
  ...
  hash_add(&got_L2_hash, "val", revm_create_L2ENT(elfsh_get_got_val,
           elfsh_set_got_val,
           ASPECT_TYPE_LONG, NULL,
           NULL, NULL, NULL));
  //hash_add(&got_L2_hash, "idx" , revm_create_L2ENT());
  hash_add(&got_L2_hash, "addr", revm_create_L2ENT(elfsh_get_got_addr,
           elfsh_set_got_addr,
           ASPECT_TYPE_LONG, NULL,
           NULL, NULL, NULL));
}

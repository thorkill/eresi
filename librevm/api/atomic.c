...
int     revm_arithmetics(revmexpr_t *dest, revmexpr_t *e1, revmexpr_t *e2,
                         u_char op)
{
  eresi_Addr    src;
  eresi_Addr    dst;
...
int     revm_hash_add(hash_t *h, revmexpr_t *e)
{
  ...
  if (!o->kname && !o->hname && !o->get_name)
    ...
    {
      key = (char *) (o->kname ? o->kname : (o->hname ? o->hname : o->get_name(
          o->root, o->parent)));
    }
...
int     revm_elist_add(list_t *h, revmexpr_t *e)
{
  ...
  if (!o->kname && !o->hname && !o->get_name)
    ...
    {
      key = (o->kname ? o->kname : o->hname ? o->hname : o->get_name(o->root,
             o->parent));
      key = strdup(key);
    }

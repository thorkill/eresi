  ...
  switch (pci_conf_type)
    ...
    case PCI_CONF_TYPE_1:
      ...
      switch (len)
        {
        case 1:
          *value = ke2dbg_inb(0xCFC + (reg & 3));
          result = 0;
          break;

        case 2:
          *value = ke2dbg_inw(0xCFC + (reg & 2));
          result = 0;
          break;

        case 4:
          *value = ke2dbg_inl(0xCFC);
          result = 0;
          break;
        }
    ...
    case PCI_CONF_TYPE_2:
      ...
      switch (len)
        {
        case 1:
          *value = ke2dbg_inb(PCI_CONF2_ADDRESS(dev, reg));
          result = 0;
          break;

        case 2:
          *value = ke2dbg_inw(PCI_CONF2_ADDRESS(dev, reg));
          result = 0;
          break;

        case 4:
          *value = ke2dbg_inl(PCI_CONF2_ADDRESS(dev, reg));
          result = 0;
          break;
        }
  ...
  switch (pci_conf_type)
    ...
    case PCI_CONF_TYPE_1:
      ...
      switch (len)
        {
        case 1:
          ke2dbg_outb((unsigned char)value, 0xCFC + (reg & 3));
          result = 0;
          break;

        case 2:
          ke2dbg_outw((unsigned short)value, 0xCFC + (reg & 2));
          result = 0;
          break;

        case 4:
          ke2dbg_outl(value, 0xCFC);
          result = 0;
          break;
        }
    ...
    case PCI_CONF_TYPE_2:
      ...
      switch (len)
        {
        case 1:
          ke2dbg_outb((unsigned char)value, PCI_CONF2_ADDRESS(dev, reg));
          result = 0;
          break;

        case 2:
          ke2dbg_outw((unsigned short)value, PCI_CONF2_ADDRESS(dev, reg));
          result = 0;
          break;

        case 4:
          ke2dbg_outl(value, PCI_CONF2_ADDRESS(dev, reg));
          result = 0;
          break;
        }
 ...
 * @return
 */
unsigned int pci_get_name(unsigned int v, unsigned int d,
  ...
  for (ctrl_bus = 0; ctrl_bus < 255; ctrl_bus++)
    for (ctrl_dev = 0; ctrl_dev < 31; ctrl_dev++)
      for (ctrl_fn = 0; ctrl_fn < 7; ctrl_fn++)
        {
          result = pci_conf_read(ctrl_bus, ctrl_dev, ctrl_fn, PCI_vendor_id, 2,
                                 &vendor  );
          result = pci_conf_read(ctrl_bus, ctrl_dev, ctrl_fn, PCI_device_id, 2,
                                 &device  );

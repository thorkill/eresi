...
void            e2dbg_register_command(void)
{
  ...
  revm_command_add(CMD_LINKMAP, (void *) cmd_linkmap, NULL,            1,
                   HLP_LINKMAP);
  ...
  revm_command_add(CMD_WATCH, (void *) cmd_watch, revm_getvarparams, 1,
                   HLP_WATCH);
  revm_command_add(CMD_BP2, (void *) cmd_bp, revm_getvarparams, 1, HLP_BP);
  revm_command_add(CMD_STACK, (void *) cmd_stack, revm_getoption,    1,
                   HLP_STACK);
  revm_command_add(CMD_DBGSTACK, (void *) cmd_dbgstack, revm_getoption,    1,
                   HLP_DBGSTACK);
  revm_command_add(CMD_DUMPREGS, (void *) cmd_dumpregs, NULL,            1,
                   HLP_DUMPREGS);
  revm_command_add(CMD_DELETE, (void *) cmd_delete, revm_getvarparams,    1,
                   HLP_DELETE);
  revm_command_add(CMD_CONTINUE, (void *) cmd_cont, (void *) NULL,   1,
                   HLP_CONTINUE);
  revm_command_add(CMD_CONTINUE2, (void *) cmd_cont, (void *) NULL,   1,
                   HLP_CONTINUE);
  revm_command_add(CMD_CONTINUE3, (void *) cmd_cont, (void *) NULL,   1,
                   HLP_CONTINUE);
  revm_command_add(CMD_NEXT,      (void *) cmd_next, (void *) NULL,   1,
                   HLP_NEXT);
  revm_command_add(CMD_NEXT2,     (void *) cmd_next, (void *) NULL,   1,
                   HLP_NEXT);
  ...
  revm_command_add(CMD_DISPLAY, (void *) cmd_display, revm_getvarparams, 1,
                   HLP_DISPLAY);
  revm_command_add(CMD_UNDISPLAY, (void *) cmd_undisplay, revm_getvarparams, 1,
                   HLP_UNDISPLAY);
  ...
  revm_command_add(CMD_THREADS, (void *) cmd_threads, revm_getvarparams, 1,
                   HLP_THREADS);
...
int   e2dbg_entry(e2dbgparams_t *params)
{
  ...
  if (e2dbgworld.sourcing)
    {
      fprintf(stderr,
              "e2dbg_entry called with SOURCED program ! calling execscript \n");

...
void    e2dbg_print_regvars_ia32_sysv()
{
  ...
  e2dbg_register_dump("EAX",
                      e2dbgworld.curthread->context->uc_mcontext.gregs[REG_EAX]);
  e2dbg_register_dump("EBX",
                      e2dbgworld.curthread->context->uc_mcontext.gregs[REG_EBX]);
  e2dbg_register_dump("ECX",
                      e2dbgworld.curthread->context->uc_mcontext.gregs[REG_ECX]);
  e2dbg_register_dump("EDX",
                      e2dbgworld.curthread->context->uc_mcontext.gregs[REG_EDX]);
  e2dbg_register_dump("ESI",
                      e2dbgworld.curthread->context->uc_mcontext.gregs[REG_ESI]);
  e2dbg_register_dump("EDI",
                      e2dbgworld.curthread->context->uc_mcontext.gregs[REG_EDI]);
  e2dbg_register_dump("ESP",
                      e2dbgworld.curthread->context->uc_mcontext.gregs[REG_ESP]);
  e2dbg_register_dump("EBP",
...
void      e2dbg_get_regvars_ia32_sysv()
{
  ...
  E2DBG_GETREG(E2DBG_SP_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_ESP]);
  E2DBG_GETREG(E2DBG_SSP_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_UESP]);
  E2DBG_GETREG(E2DBG_FP_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_EBP]);
  E2DBG_GETREG(E2DBG_PC_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_EIP]);

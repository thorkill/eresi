...
void      e2dbg_get_regvars_sparc32_sysv()
{
  ...
  E2DBG_GETREG(E2DBG_PC_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_PC]);
  E2DBG_GETREG(E2DBG_NPC_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_nPC]);
  E2DBG_GETREG(E2DBG_Y_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_Y]);
  E2DBG_GETREG(E2DBG_G1_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_G1]);
  E2DBG_GETREG(E2DBG_G2_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_G2]);
  E2DBG_GETREG(E2DBG_G3_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_G3]);
  E2DBG_GETREG(E2DBG_G4_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_G4]);
  E2DBG_GETREG(E2DBG_G5_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_G5]);
  E2DBG_GETREG(E2DBG_G5_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_G6]);
  E2DBG_GETREG(E2DBG_G7_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_G7]);
  E2DBG_GETREG(E2DBG_O0_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_O0]);
  E2DBG_GETREG(E2DBG_O1_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_O1]);
  E2DBG_GETREG(E2DBG_O2_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_O2]);
  E2DBG_GETREG(E2DBG_O3_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_O3]);
  E2DBG_GETREG(E2DBG_O4_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_O4]);
  E2DBG_GETREG(E2DBG_O5_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_O5]);
  E2DBG_GETREG(E2DBG_O6_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_O6]);
  E2DBG_GETREG(E2DBG_O7_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_O7]);
#endif
  PROFILER_OUT(__FILE__, __FUNCTION__, __LINE__);
}
...
void      e2dbg_set_regvars_sparc32_sysv()
{
  ...
  E2DBG_SETREG(E2DBG_PC_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_PC]);
  E2DBG_SETREG(E2DBG_NPC_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_nPC]);
  E2DBG_SETREG(E2DBG_Y_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_Y]);
  E2DBG_SETREG(E2DBG_G1_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_G1]);
  E2DBG_SETREG(E2DBG_G2_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_G2]);
  E2DBG_SETREG(E2DBG_G3_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_G3]);
  E2DBG_SETREG(E2DBG_G4_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_G4]);
  E2DBG_SETREG(E2DBG_G5_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_G5]);
  E2DBG_SETREG(E2DBG_G5_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_G6]);
  E2DBG_SETREG(E2DBG_G7_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_G7]);
  E2DBG_SETREG(E2DBG_O0_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_O0]);
  E2DBG_SETREG(E2DBG_O1_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_O1]);
  E2DBG_SETREG(E2DBG_O2_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_O2]);
  E2DBG_SETREG(E2DBG_O3_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_O3]);
  E2DBG_SETREG(E2DBG_O4_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_O4]);
  E2DBG_SETREG(E2DBG_O5_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_O5]);
  E2DBG_SETREG(E2DBG_O6_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_O6]);
  E2DBG_SETREG(E2DBG_O7_VAR,
               e2dbgworld.curthread->context->uc_mcontext.gregs[REG_O7]);
#endif
  PROFILER_OUT(__FILE__, __FUNCTION__, __LINE__);
}
...
#if __DEBUG_BREAKPOINTS__
  fprintf(stderr,
          "[DEBUG_BREAKPOINTS:sparc32] Address64 to be flushed: %016llx \n", addr64);
#endif

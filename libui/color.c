...
{
  return revm_colorget("%s", "instr", text);
}
char *revm_colorstr(char *text)
{
  return revm_colorget("%s", "string", text);
}
char *revm_colorfieldstr(char *text)
{
  return revm_colorget("%s", "fieldstring", text);
}
char *revm_colortypestr(char *text)
{
  return revm_colorget("%s", "typestring", text);
}
char *revm_colorend(char *text)
{
  return revm_colorget("%s", "endstring", text);
}
char *revm_colorwarn(char *text)
{
  return revm_colorget("%s", "warnstring", text);
}
char *revm_colorfunction(char *text)
{
  return revm_colorget("%s", "function", text);
}
char *revm_colorfilename(char *text)
{
  return revm_colorget("%s", "filename", text);
}

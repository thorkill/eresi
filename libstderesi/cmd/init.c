...
void		eresi_commands_init()
{
  ...
  revm_command_add(CMD_RELINJCT,  cmd_relinject, revm_getoption2   , 0, HLP_RELINJCT);
  ...
  revm_command_add(CMD_NETWORK, cmd_network, revm_getvarparams, 0, HLP_NETWORK);
  revm_command_add(CMD_NETWORK_GDBSUPPORT, cmd_network_gdbsupport,
		   revm_getvarparams, 0, HLP_NETWORKGDB);

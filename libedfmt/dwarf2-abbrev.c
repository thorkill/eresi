 ...
 */
int     edfmt_dwarf2_abbrev_read(edfmtdw2abbent_t *ent, u_long fnum,
                                 u_long ipos)
{
                ...
                case DW_LNS_extended_op:
                  ...
                  switch (ext_opc)
                    ...
                    case DW_LNE_define_file:
                      header->files_number++;
                      /* Realloc pointers */
                      XREALLOC(__FILE__, __FUNCTION__, __LINE__, header->files_name,
                               header->files_name,
                               sizeof(char *)*header->files_number, -1);
                      XREALLOC(__FILE__, __FUNCTION__, __LINE__, header->files_dindex,
                               header->files_dindex,
                               sizeof(u_int)*header->files_number, -1);
                      XREALLOC(__FILE__, __FUNCTION__, __LINE__, header->files_time,
                               header->files_time,
                               sizeof(u_int)*header->files_number, -1);

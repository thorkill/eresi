  ...
  switch (linktype)
    ...
    case CONTAINER_LINK_IN:
      ...
      if (newlist)
        ...
        {
          XALLOC(__FILE__, __FUNCTION__, __LINE__, container->inlinks, sizeof(list_t),
                 -1);
    ...
    case CONTAINER_LINK_OUT:
      ...
      if (newlist)
        ...
        {
          XALLOC(__FILE__, __FUNCTION__, __LINE__, container->outlinks, sizeof(list_t),
                 -1);
 ...
 */
container_t *container_create(u_int type, void *data, list_t *inlist,
                              list_t *outlist, u_int uniqid)
{
...
#endif
  XALLOC(__FILE__, __FUNCTION__, __LINE__, newcntnr,
         sizeof(container_t) + rtype->size, NULL);

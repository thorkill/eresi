...
void  btree_browse_prefix(btree_t *root, int (*apply)(void *, void *),
                          void *ptr)
{
  if (root)
    {
...
void  btree_browse_suffix(btree_t *root, int (*apply)(void *, void *),
                          void *ptr)
{
  if (root)
    {
...
void  btree_browse_prefix_debug(btree_t *root, int (*apply)(void *, void *,
                                btree_t *),
                                void *ptr)
{
  if (root)

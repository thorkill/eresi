 ...
 */
void    *kernsh_readmema_mem_linux(elfshobj_t *unused, eresi_Addr offset,
                                   void *buf, int size)
{
  eresi_Addr  roffset;
 ...
 * @return size on success, -1 on error
 */
int   kernsh_writemem_mem_linux(elfshobj_t *unused, eresi_Addr offset,
                                void *buf, int size)
{
  eresi_Addr  roffset;
...
void  *kernsh_readmema_netbsd(elfshobj_t *file, eresi_Addr offset, void *buf,
                              int size)
{
  PROFILER_IN(__FILE__, __FUNCTION__, __LINE__);
...
int kernsh_writemem_netbsd(elfshobj_t *unused, eresi_Addr offset, void *buf,
                           int size)
{
  PROFILER_IN(__FILE__, __FUNCTION__, __LINE__);

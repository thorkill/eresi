 ...
 */
void  *kernsh_readmema_kmem_linux_2_6(elfshobj_t *unused, eresi_Addr offset,
                                      void *buf, int size)
{
  PROFILER_IN(__FILE__, __FUNCTION__, __LINE__);
 ...
 * @return size on success, -1 on error
 */
int kernsh_writemem_kmem_linux_2_6(elfshobj_t *file, eresi_Addr offset,
                                   void *buf, int size)
{
  PROFILER_IN(__FILE__, __FUNCTION__, __LINE__);
 ...
 * @return size on success, -1 on error
 */
void  *kernsh_readmema_kmem_linux_2_4(elfshobj_t *unused, eresi_Addr offset,
                                      void *buf, int size)
{
  PROFILER_IN(__FILE__, __FUNCTION__, __LINE__);
 ...
 * @return size on success, -1 on error
 */
int kernsh_writemem_kmem_linux_2_4(elfshobj_t *unused, eresi_Addr offset,
                                   void *buf, int size)
{
  PROFILER_IN(__FILE__, __FUNCTION__, __LINE__);

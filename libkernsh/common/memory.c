...
int kernsh_openmem()
{
  ...
  libkernshworld.kernel_start = (eresi_Addr) config_get_data(
                                  LIBKERNSH_CONFIG_KERNEL_START);
  libkernshworld.kernel_end = (eresi_Addr) config_get_data(
                                LIBKERNSH_CONFIG_KERNEL_END);

 ...
 */
elfshsect_t *elfsh_get_hashtable_by_range(elfshobj_t *file, eresi_Addr range,
    int *num)
{
  elfshsect_t *new;
  int   nbr;
 ...
 */
elfsh_Verdef    *elfsh_hash_getdef(elfshobj_t *file, char *name, void *defdata,
                                   int size)
{
  elfsh_Verdef  *table;
  elfsh_Half  *sym;

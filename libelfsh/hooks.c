...
void    elfsh_setup_hooks()
{
  ...
  elfsh_register_readmema(ELFSH_OS_LINUX, ELFSH_IOTYPE_EMBEDDED,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_LINUX, ELFSH_IOTYPE_STATIC,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_FREEBSD, ELFSH_IOTYPE_EMBEDDED,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_FREEBSD, ELFSH_IOTYPE_STATIC,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_NETBSD, ELFSH_IOTYPE_EMBEDDED,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_NETBSD, ELFSH_IOTYPE_STATIC,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_OPENBSD, ELFSH_IOTYPE_EMBEDDED,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_OPENBSD, ELFSH_IOTYPE_STATIC,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_SOLARIS, ELFSH_IOTYPE_EMBEDDED,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_SOLARIS, ELFSH_IOTYPE_STATIC,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_BEOS, ELFSH_IOTYPE_EMBEDDED,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_BEOS, ELFSH_IOTYPE_STATIC,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_IRIX, ELFSH_IOTYPE_EMBEDDED,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_IRIX, ELFSH_IOTYPE_STATIC,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_HPUX, ELFSH_IOTYPE_EMBEDDED,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_HPUX, ELFSH_IOTYPE_STATIC,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_ARM, ELFSH_IOTYPE_EMBEDDED,
                          elfsh_get_raw_by_addr);
  elfsh_register_readmema(ELFSH_OS_ARM, ELFSH_IOTYPE_STATIC,
                          elfsh_get_raw_by_addr);
  ...
  elfsh_register_writememf(ELFSH_HOST_USER, LIBELFSH_MODE_STATIC,
                           elfsh_raw_write);
  elfsh_register_writememf(ELFSH_HOST_USER, LIBELFSH_MODE_RUNTIME,
                           elfsh_raw_write);

				  ...
				  void	 *fct)
{
  ...
  dim[1] = objtype;
  dim[2] = ostype;
  aspect_vectors_insert(altplt, dim, 3, (elfsh_Addr) fct);
  ELFSH_PROFILE_ROUT(__FILE__, __FUNCTION__, __LINE__, 0);
}
					  ...
					  void *fct)
{
  ...
  dim[1] = objtype;
  dim[2] = ostype;
  aspect_vectors_insert(extplt, dim, 3, (elfsh_Addr) fct);
  ELFSH_PROFILE_ROUT(__FILE__, __FUNCTION__, __LINE__, 0);
}
				       ...
				       void *fct)
{
  ...
  dim[1] = objtype;
  dim[2] = ostype;
  aspect_vectors_insert(plt, dim, 3, (elfsh_Addr) fct);
  ELFSH_PROFILE_ROUT(__FILE__, __FUNCTION__, __LINE__, 0);
}
				     ...
				     u_char ostype, void *fct)
{
  ...
  dim[1] = objtype;
  dim[2] = ostype;
  aspect_vectors_insert(encodeplt, dim, 3, (elfsh_Addr) fct);
  ELFSH_PROFILE_ROUT(__FILE__, __FUNCTION__, __LINE__, 0);
}
				      ...
				      u_char ostype, void *fct)
{
  ...
  dim[1] = objtype;
  dim[2] = ostype;
  aspect_vectors_insert(encodeplt1, dim, 3, (elfsh_Addr) fct);
  ELFSH_PROFILE_ROUT(__FILE__, __FUNCTION__, __LINE__, 0);
}
			       ...
			       void *fct)
{
  ...
  dim[1] = objtype;
  dim[2] = ostype;
  aspect_vectors_insert(rel, dim, 3, (elfsh_Addr) fct);
  ELFSH_PROFILE_ROUT(__FILE__, __FUNCTION__, __LINE__, 0);
}
				 ...
				 u_char ostype, void *fct)
{
  ...
  dim[1] = objtype;
  dim[2] = ostype;
  aspect_vectors_insert(cflow, dim, 3, (elfsh_Addr) fct);
  ELFSH_PROFILE_ROUT(__FILE__, __FUNCTION__, __LINE__, 0);
}
				 ...
				 u_char ostype, void *fct)
{
  ...
  dim[1] = objtype;
  dim[2] = ostype;
  aspect_vectors_insert(breakp, dim, 3, (elfsh_Addr) fct);
  ELFSH_PROFILE_ROUT(__FILE__, __FUNCTION__, __LINE__, 0);
}
				 ...
				 u_char ostype, void *fct)
{
  ...
  dim[1] = objtype;
  dim[2] = ostype;
  aspect_vectors_insert(argcp, dim, 3, (elfsh_Addr) fct);
  ELFSH_PROFILE_ROUT(__FILE__, __FUNCTION__, __LINE__, 0);
}
			    ...
			    elfsh_Addr *l, elfsh_Addr a, elfshsect_t *m)
{
  ...
  dim[1] = elftype;
  dim[2] = ostype;
  fct    = aspect_vectors_select(rel, dim, 3);
  ret = fct(s, r, l, a, m);
  if (ret < 0)
    ELFSH_PROFILE_ERR(__FILE__, __FUNCTION__, __LINE__,
			    ...
			    elfsh_Addr new)
{
  ...
  dim[1] = elftype;
  dim[2] = ostype;
  fct    = aspect_vectors_select(cflow, dim, 3);
...
int             elfsh_plt(elfshobj_t *file, elfsh_Sym *s, elfsh_Addr new)
{
  ...
  dim[1] = elftype;
  dim[2] = ostype;
  fct    = aspect_vectors_select(plt, dim, 3);
  ret    = fct(file, s, new);
  if (ret < 0)
    ELFSH_PROFILE_ERR(__FILE__, __FUNCTION__, __LINE__,
				...
				elfsh_Addr diff, u_int off)
{
  ...
  dim[1] = elftype;
  dim[2] = ostype;
  fct    = aspect_vectors_select(encodeplt, dim, 3);
				 ...
				 elfshsect_t *extplt, elfsh_Addr diff)
{
  ...
  dim[1] = elftype;
  dim[2] = ostype;
  fct    = aspect_vectors_select(encodeplt1, dim, 3);
...
int             elfsh_altplt(elfshobj_t *file, elfsh_Sym *s, elfsh_Addr new)
{
  ...
  dim[1] = elftype;
  dim[2] = ostype;
  fct    = aspect_vectors_select(altplt, dim, 3);
  ret  = fct(file, s, new);
  if (ret < 0)
    ELFSH_PROFILE_ERR(__FILE__, __FUNCTION__, __LINE__,
			     ...
			     elfshsect_t *dynsym, elfshsect_t *relplt)
{
  ...
  dim[1] = elftype;
  dim[2] = ostype;
  fct    = aspect_vectors_select(vextplt, dim, 3);
...
int		  elfsh_setbreak(elfshobj_t *file, elfshbp_t *bp)
{
  ...
  dim[1] = elftype;
  dim[2] = ostype;
  fct    = aspect_vectors_select(breakh, dim, 3);
  ret  = fct(file, bp);
  if (ret < 0)
    ELFSH_PROFILE_ERR(__FILE__, __FUNCTION__, __LINE__,
...
int		  *elfsh_args_count(elfshobj_t *file, u_int off, elfsh_Addr vaddr)
{
  ...
  dim[1] = elftype;
  dim[2] = ostype;
  fct    = aspect_vectors_select(argch, dim, 3);

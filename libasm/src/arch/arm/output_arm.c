...
char *asm_arm_get_register(int reg)
{
  switch (reg)
    ...
    case ASM_ARM_REG_R10:
      return "r10";

    case ASM_ARM_REG_R11:
      return "r11";

    case ASM_ARM_REG_R12:
      return "r12";

    case ASM_ARM_REG_R13:
      return "sp";

    case ASM_ARM_REG_R14:
      return "lr";
...
char *asm_arm_get_coprocessor(int coproc)
{
  switch (coproc)
    {
    case ASM_ARM_COPROC_P0:
      return "p0";

    case ASM_ARM_COPROC_P1:
      return "p1";

    case ASM_ARM_COPROC_P2:
      return "p2";

    case ASM_ARM_COPROC_P3:
      return "p3";

    case ASM_ARM_COPROC_P4:
      return "p4";

    case ASM_ARM_COPROC_P5:
      return "p5";

    case ASM_ARM_COPROC_P6:
      return "p6";

    case ASM_ARM_COPROC_P7:
      return "p7";

    case ASM_ARM_COPROC_P8:
      return "p8";

    case ASM_ARM_COPROC_P9:
      return "p9";

    case ASM_ARM_COPROC_P10:
      return "p10";

    case ASM_ARM_COPROC_P11:
      return "p11";

    case ASM_ARM_COPROC_P12:
      return "p12";

    case ASM_ARM_COPROC_P13:
      return "p13";

    case ASM_ARM_COPROC_P14:
      return "p14";

    case ASM_ARM_COPROC_P15:
      return "p15";
...
char *asm_arm_get_coprocessor_register(int reg)
{
  switch (reg)
    {
    case ASM_ARM_COPROC_REG_CR0:
      return "cr0";

    case ASM_ARM_COPROC_REG_CR1:
      return "cr1";

    case ASM_ARM_COPROC_REG_CR2:
      return "cr2";

    case ASM_ARM_COPROC_REG_CR3:
      return "cr3";

    case ASM_ARM_COPROC_REG_CR4:
      return "cr4";

    case ASM_ARM_COPROC_REG_CR5:
      return "cr5";

    case ASM_ARM_COPROC_REG_CR6:
      return "cr6";

    case ASM_ARM_COPROC_REG_CR7:
      return "cr7";

    case ASM_ARM_COPROC_REG_CR8:
      return "cr8";

    case ASM_ARM_COPROC_REG_CR9:
      return "cr9";

    case ASM_ARM_COPROC_REG_CR10:
      return "cr10";

    case ASM_ARM_COPROC_REG_CR11:
      return "cr11";

    case ASM_ARM_COPROC_REG_CR12:
      return "cr12";

    case ASM_ARM_COPROC_REG_CR13:
      return "cr13";

    case ASM_ARM_COPROC_REG_CR14:
      return "cr14";

    case ASM_ARM_COPROC_REG_CR15:
      return "cr15";

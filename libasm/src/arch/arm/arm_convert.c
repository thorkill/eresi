...
void  arm_convert_coproc_dataproc(struct s_arm_decode_coproc_dataproc *opcode,
                                  u_char *buf)
{
#if __BYTE_ORDER == __LITTLE_ENDIAN
  int   converted;
...
void  arm_convert_coproc_mov(struct s_arm_decode_coproc_mov *opcode,
                             u_char *buf)
{
#if __BYTE_ORDER == __LITTLE_ENDIAN
  int   converted;
...
void  arm_convert_coproc_mov2(struct s_arm_decode_coproc_mov2 *opcode,
                              u_char *buf)
{
#if __BYTE_ORDER == __LITTLE_ENDIAN
  int   converted;
...
void  arm_convert_coproc_ldst(struct s_arm_decode_coproc_ldst *opcode,
                              u_char *buf)
{
#if __BYTE_ORDER == __LITTLE_ENDIAN
  int   converted;

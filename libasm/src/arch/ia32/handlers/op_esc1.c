      ...
      switch (modrm->r)
        ...
        case 5:
          ...
          switch (modrm->m)
            ...
            case 1:
              new->instr = ASM_FLDL2T;
              break;

            case 2:
              new->instr = ASM_FLDL2E;
              break;
            ...
            case 4:
              new->instr = ASM_FLDLG2;
              break;

            case 5:
              new->instr = ASM_FLDLN2;
              break;
        ...
        case 6:
          ...
          switch (modrm->m)
            ...
            case 3:
              new->instr = ASM_FPATAN;
              break;

            case 4:
              new->instr = ASM_FXTRACT;
              break;

            //case 5: new->instr = ASM_FPREM1; break;
            case 6:
              new->instr = ASM_FDECSTP;
              break;

            case 7:
              new->instr = ASM_FINCSTP;
              break;
            }
        ...
        case 7:
          ...
          switch (modrm->m)
            ...
            case 3:
              new->instr = ASM_FSINCOS;
              break;

            case 4:
              new->instr = ASM_FRNDINT;
              break;

            case 5:
              new->instr = ASM_FSCALE;
              break;

                          ...
                          unsigned long fcn)
{
  ...
  LIBASM_PROFILE_FIN();
  vec = aspect_vector_get(vector_name);
  dim[0] = operand_type;
  aspect_vectors_insert(vec, dim, fcn);
  LIBASM_PROFILE_FOUT(1);
}
...
{
  LIBASM_PROFILE_FIN();
  asm_register_operand("operand", operand_type, fcn);
  LIBASM_PROFILE_FOUT(1);
}
...
{
  LIBASM_PROFILE_FIN();
  asm_register_operand("operand-sparc", operand_type, fcn);
  LIBASM_PROFILE_FOUT(1);
}

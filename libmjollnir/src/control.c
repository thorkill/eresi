...
**
** $Id: control.c,v 1.23 2007-04-01 23:33:16 may Exp $
**
*/
				   ...
				   elfsh_Addr	vaddr)
{
  ...
  mjr_container_add_link(tmpcntnr, main_b->id, MJR_LINK_FUNC_CALL, MJR_LINK_OUT);
  mjr_container_add_link(main_b, tmpcntnr->id, MJR_LINK_FUNC_RET, MJR_LINK_IN);

  mjr_blocks_link_call(context, 
		       vaddr, 
		       main_addr, 
		       vaddr + dis);
